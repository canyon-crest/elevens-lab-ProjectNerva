...
public class DeckTester5_1 {
	...
	private static void test1CardDeck() {
		...
		String[] s1 = {"spades"};
		int[] v1 = {1};
		Deck5_1 d = new Deck5_1(r1, s1, v1);
		testOneCard(d, new Card5_1("ace", "spades", 1));
		testEmpty(d);
	...
	private static void test2CardDeck() {
		...
		String[] s2 = {"hearts"};
		int[] v2 = {1, 2};
		Deck5_1 d = new Deck5_1(r2, s2, v2);
		...
		aceIsFirst = c.matches(new Card5_1("ace", "hearts", 1));
		twoIsFirst = c.matches(new Card5_1("2", "hearts", 2));
		...
		if (aceIsFirst) {
			assert c.matches(new Card5_1("2", "hearts", 2))	: "2nd card dealt is "
				+ c + ". It is not one of the two correct cards.";
		} else {
			assert c.matches(new Card5_1("ace", "hearts", 1)) : "2nd card dealt is "
				+ c + ". It is not one of the two correct cards.";
		}
		testEmpty(d);
		...
		if (aceIsFirst) {
			assert c.matches(new Card5_1("2", "hearts", 2))
				: "2nd card dealt after shuffle is " + c
				+ ". It is not the one of the two correct cards.";
		} else {
			assert c.matches(new Card5_1("ace", "hearts", 1))
				: "2nd card dealt after shuffle is " + c
				+ ". It is not the one of the two correct cards.";
		}
		testEmpty(d);
	 ...
	 */
	private static void testEmpty(Deck5_1 d) {
	 ...
	 */
	private static void testOneCard(Deck5_1 d, Card5_1 intended) {
		assert d.size() == 1 : "Size is " + d.size()
	...
	private static void testShuffle() {
		...
		Deck5_1 d1 = new Deck5_1(r, s, v);
		Deck5_1 d2 = new Deck5_1(r, s, v);
